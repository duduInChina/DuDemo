...
fun MediaItem.Builder.from(id: String, uri: String, mimeType: String? = "",
                           title: String? = "", artist: String? = "", albumTitle: String? = "",
                           albumArtist: String? = "", artworkUri: Uri? = null,
                           duration: Long = 0): MediaItem.Builder{
